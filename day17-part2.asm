	...
	.balign	8
	.type	map, @object
	.set	MAP_SIZE, 16*1024*1024
	.size	map, MAP_SIZE
map: 	.zero	MAP_SIZE
	.type	pool, @object
	.set	CHUNKS_CNT, 64*1024
	.set	CHUNKS_SIZE, 40
...
main_loop_next:
	...
	# only move forward if no more than ten
...
skip_forward:
	...
	# only turn if at least 4 steps
	# moved in the same direction
	li	t0, 4
	blt	s6, t0, skip_turns
